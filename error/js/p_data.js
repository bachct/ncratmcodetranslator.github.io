function p_data() {
    var text;
    var code = document.getElementById("p_Input").value;
    var str = code;
    var bit0 = ["Always."+"<br>"]; 
...
text = document.getElementById("Byte0").innerHTML = (text+text2);
...
text = document.getElementById("Byte1").innerHTML = (text+text2);
    var text;
    var code = document.getElementById("p_Input").value;
    var str = code;
    ...
    text = document.getElementById("Byte2").innerHTML = (text+text2);
    ...
    } else if (res2 == "F")
    {
      ...
      text = document.getElementById("Byte3").innerHTML = (text+text2);
