function p_byte3() {
    var text;
    var code = document.getElementById("p_Input3").value;
    var str = code;
    var bit0 = ["1 - Knife jam status."+"<br>"]; 
    var bit1 = ["1 - Paper jam status."+"<br>"];
    var bit2 = ["1 - Failed to detect black mark status."+"<br>"]; 
    var bit3 = ["0 - Always."+"<br>"];
    ...
    } else if (res2 == "F")
    {
      ...
      text = document.getElementById("p_Byte3").innerHTML = (text+text2);
